...
const RecordCreate = ({
  ...
  const { register, control, handleSubmit, reset } = useForm({
    ...
    defaultValues: {
      principleAmount: Number(selectedRecord?.principleAmount??0),
      roi: Number(selectedRecord?.roi??0),
      // purchaseDate: selectedRecord?.purchaseDate!,
      // dueDate: selectedRecord?.dueDate?  dayjs(selectedRecord?.dueDate) : null,
