...
const AllModals = () => {
  const { state, toggle, handleclose } = useToggle(false);
  const {
    state: open2,
    toggle: toggle2,
  ...
  return (
    <div>
      <CustomButton type="button" onClick={toggle}>
        <Typography>Open Modal</Typography>
      </CustomButton>

      <CustomButton type="button" onClick={toggle2}>
        <Typography>Open long Modal</Typography>
      </CustomButton>

      <MuiModalWrapper title="Modal 1" open={state} onClose={handleclose}>
        <h1>this is modal</h1>
      </MuiModalWrapper>

      <MuiModalWrapper title="Modal 2" open={open2} onClose={handleclose2}>
